...
#ifndef CLEDGER_UTIL_SEGMENT_PIPELINE_INTERESTS_FIXED_HPP
#define CLEDGER_UTIL_SEGMENT_PIPELINE_INTERESTS_FIXED_HPP
...
#endif // CLEDGER_UTIL_SEGMENT_PIPELINE_INTERESTS_FIXED_HPP
