...
#ifndef CLEDGER_UTIL_SEGMENT_DATA_FETCHER_HPP
#define CLEDGER_UTIL_SEGMENT_DATA_FETCHER_HPP
...
public:
  ...
  fetch(Face& face, const Interest& interest, int maxNackRetries, int maxTimeoutRetries,
        ndn::DataCallback onData, FailureCallback onTimeout, FailureCallback onNack);
...
private:
  ...
  void
  handleNack(const Interest& interest, const ndn::lp::Nack& nack, const shared_ptr<DataFetcher>& self);
...
private:
  ...
  ndn::PendingInterestHandle m_pendingInterest;
...
#endif // CLEDGER_UTIL_SEGMENT_DATA_FETCHER_HPP
