...
Ledger::Ledger(const Name& prefix, const Name& topic, ndn::Face& face, 
...
void
Ledger::serveClient(std::shared_ptr<ClientOptions> client)
{
...
void
Ledger::listen(const UpdateCallback& onUpdateCallback)
{
  if (m_topic.empty()) {
...
void
Ledger::onValidationSuccess(const Data& data, std::shared_ptr<ClientOptions> client)
{
...
void
Ledger::onValidationFailure(const Data& data, const ndn::security::ValidationError& error,
